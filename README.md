...
This repository contains the code to train and evaluate the work presented in the article [Extending 3D body pose estimation for robotic-assistive therapies of autistic children](https://ieeexplore.ieee.org/document/10719777). 

<pre lang="markdown"> ```bibtex @INPROCEEDINGS{Santos2024,
